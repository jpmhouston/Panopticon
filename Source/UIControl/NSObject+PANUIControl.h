 ...
 *
 *  Variation on `pan_observeControlForPress:withBlock:` that adds an operation queue parameter. See the description
 *  for that method.
 *
 *  @param control The control to observe.
 ...
 *
 *  Variation on `pan_observeControlForPress:withBlock:` that adds a GCD dispatch queue parameter. See the description
 *  for that method.
 *
 *  @param control The control to observe.
 ...
 *
 *  Variation on `pan_observeControlForValue:withBlock:` that adds an operation queue parameter. See the description
 *  for that method.
 *
 *  @param control The control to observe.
 *  @param queue   The operation queue on which to call `block`.
 ...
 *
 *  Variation on `pan_observeControlForValue:withBlock:` that adds a GCD dispatch queue parameter. See the description
 *  for that method.
 *
 *  @param control The control to observe.
 *  @param queue   The GCD dispatch queue on which to call `block`.
 ...
 *
 *  Variation on `pan_observeControl:forEvents:withBlock:` that adds an operation queue parameter. See the description
 *  for that method.
 *
 *  @param control The control to observe.
 *  @param events  A bitmask of the events to observe.
 ...
 *
 *  Variation on `pan_observeControl:forEvents:withBlock:` that adds a GCD dispatch queue parameter. See the description
 *  for that method.
 *
 *  @param control The control to observe.
 *  @param events  A bitmask of the events to observe.
